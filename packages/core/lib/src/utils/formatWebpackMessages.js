...
function formatWebpackMessages(json) {
    var formattedErrors = json.errors.map(function (data) { return formatMessage(data.message); });
    var formattedWarnings = json.warnings.map(function (data) { return formatMessage(data.message); });
